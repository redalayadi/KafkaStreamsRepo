...
object FavouriteColorTopology {

  def main(args: Array[String]): Unit = {

    val config: Properties = new Properties

    config.put(StreamsConfig.APPLICATION_ID_CONFIG, "MyFirstTopology")
    ...
    val favouriteColours: KTable[String, java.lang.Long] = usersAndColoursTable
      ...
      .count(Materialized.as[String, java.lang.Long, KeyValueStore[Bytes, Array[Byte]]]("CountsByColours")
